...
<div class="site">
	<header class="masthead">
		<div class="container">
			<nav class="nav">
				...
				<a href="/control-panel" class="nav-link" class:active={$page.url.pathname === '/control-panel'}>Control</a>
			</nav>
			<h1 class="site-title">
				<a href="/">{SITE_NAME}</a>
			</h1>
	...
	<footer class="footer">
		<div class="container text-center text-small text-light">
			<p>
				Coverage compiled from multiple information sources using automated editorial processes.
			</p>
			<p>
				© {new Date().getFullYear()} {SITE_NAME}. All events unified.
			</p>
		</div>
	</footer>
</div>
